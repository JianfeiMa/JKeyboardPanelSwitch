...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickResolved(final View view) {
        ...
        intent.putExtra(KEY_TRANSLUCENT_STATUS_FIT_SYSTEM_WINDOW_TRUE, mTranslucentStatusTrueCb.isChecked());
        intent.putExtra(KEY_IGNORE_RECOMMEND_PANEL_HEIGHT, mIgnoreRecommendPanelHeightCb.isChecked());
        intent.putExtra(KEY_MULTI_SUB_PANEL, mMultipleSubPanelCb.isChecked());

        final ComponentName componentName;
        if (mAppCompatActivityRb.isChecked()) {
            componentName = new ComponentName(this, ChattingResolvedActivity.class);
            Log.d(TAG, "执行ChattingResolvedActivity");
        } else {
            componentName = new ComponentName(this, ChattingResolvedFragmentActivity.class);
            Log.d(TAG, "执行ChattingResolvedFragmentActivity");
        }
    ...
    public void onClickExtraThemeResolved(final View view) {
        ...
        Intent intent = new Intent(this, ChattingResolvedHandleByPlaceholderActivity.class);
        intent.putExtra(KEY_FULL_SCREEN_THEME, fullScreenTheme);
        startActivity(intent);
    }
